...
SOPCINFO_FILE := E:/Education/Academic/workspaces/CO503-Advanced-Embedded-Systems-Labs/lab04/part03/MSoC.sopcinfo
...
# The SOPC System ID 
# setting SOPC_SYSID is 12
SOPC_SYSID_FLAG += --id=12
ELF_PATCH_FLAG  += --id 12

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x100010f0
SOPC_SYSID_FLAG += --sidp=0x100010f0
ELF_PATCH_FLAG  += --sidp 0x100010f0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1718596619
SOPC_SYSID_FLAG += --timestamp=1718596619
ELF_PATCH_FLAG  += --timestamp 1718596619
...
# setting hal.stderr is jtag_uart4
ELF_PATCH_FLAG  += --stderr_dev jtag_uart4

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart4
ELF_PATCH_FLAG  += --stdin_dev jtag_uart4
...
# setting hal.stdout is jtag_uart4
ELF_PATCH_FLAG  += --stdout_dev jtag_uart4
