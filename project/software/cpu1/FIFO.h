...
#define IN_BASE_1to5 0x10001110
#define OUT_BASE_1to5 0x21048
#define CONTROL_BASE_1to5 0x10001080

#define IN_BASE_1to6 0x1000110c
#define OUT_BASE_1to6 0x21048
#define CONTROL_BASE_1to6 0x10001060
